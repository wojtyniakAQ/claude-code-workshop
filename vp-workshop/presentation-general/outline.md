# Hands-on Edition -- slide outline
...
- Digest a long report. Reconcile messy exports. Prep for a big meeting.
- Prototype an idea and hand it off.
...
## APPENDIX -- "The Technical Side" (only if asked)

Keep these from the original deck in your back pocket. Pull them up only if a
technical question comes -- they're not part of the core flow.
...
- **Plug into a real system (~10 min)** -- the strongest "not chat" moment. Show a
  ...
  enterprise unlock people remember.
