...
| You re-ask next month from scratch | Real files and a project you re-open and build on |
...
| 3 | The real difference (browser-download messy signup exports -> runs code to reconcile 58 rows into 41 people -> interactive app with a merge-audit panel) | 20 | `cards/03-real-difference.md` |
...
you merge these two?" challenge; and the finale deck
